;;; packages.el --- manny-lldb layer packages file for Spacemacs.
;;
...
;; added to `manny-lldb-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `manny-lldb/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `manny-lldb/pre-init-PACKAGE' and/or
;;   `manny-lldb/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst manny-lldb-packages
  '()
  "The list of Lisp packages required by the manny-lldb layer.
