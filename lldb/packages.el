;;; packages.el --- lldb layer packages file for Spacemacs.
;;
...
;; added to `lldb-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `lldb/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `lldb/pre-init-PACKAGE' and/or
;;   `lldb/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst lldb-packages
  '()
  "The list of Lisp packages required by the lldb layer.
